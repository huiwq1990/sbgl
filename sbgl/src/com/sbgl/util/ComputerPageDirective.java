...
public class ComputerPageDirective extends  Directive{
	@Override
	public int getLine() {
...
//			 FrontDirective frontdirective = (FrontDirective)Class.forName("com.sbgl.app.actions"+params.get("moduleName")+"Action").newInstance();
			String moduleName = (String) params.get("moduleName");
			 if(moduleName==null){
				 moduleName = "computer.ManageComputer";
			 }
			 ComputerDirective computerdirective = (ComputerDirective)Class.forName("com.sbgl.app.actions."+moduleName+"Action").newInstance();
...
//			}else 
				if ("computercategorycontent".equals(tag)) {
				computerdirective.manageComputercategoryFull(icad, params, context);
			}
