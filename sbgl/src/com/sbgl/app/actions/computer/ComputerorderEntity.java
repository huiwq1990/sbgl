...
public class ComputerorderEntity {
	...
	public Date getComputerordercreatetime() {
		return computerordercreatetime;
	}
	...
	public String getComputerorderrejectreason() {
		return computerorderrejectreason;
	}
	...
	public Integer getComputerordercomputerhomeworkid() {
		return computerordercomputerhomeworkid;
	}
	public void setComputerordercomputerhomeworkid(
			Integer computerordercomputerhomeworkid) {
		this.computerordercomputerhomeworkid = computerordercomputerhomeworkid;
	}
	public Integer getComputerorderaudituserid() {
		return computerorderaudituserid;
	}
	...
	public Integer getComputerhomeworkcomputerorderclassruleid() {
		return computerhomeworkcomputerorderclassruleid;
	}
	public void setComputerhomeworkcomputerorderclassruleid(
			Integer computerhomeworkcomputerorderclassruleid) {
	...
	public String getComputerhomeworkcontent() {
		return computerhomeworkcontent;
	}
	...
	public Integer getComputerhomeworkcreateuserid() {
		return computerhomeworkcreateuserid;
	}
	...
	public String getComputerhomeworkattachment() {
		return computerhomeworkattachment;
	}
	...
	public Date getComputerhomeworkcreatetime() {
		return computerhomeworkcreatetime;
	}
	...
	public String getComputerorderclassrulename() {
		return computerorderclassrulename;
	}
	...
	public String getComputerorderclassruleclassname() {
		return computerorderclassruleclassname;
	}
	public void setComputerorderclassruleclassname(
			String computerorderclassruleclassname) {
		this.computerorderclassruleclassname = computerorderclassruleclassname;
	}
	public Integer getComputerorderclassruleclassid() {
		return computerorderclassruleclassid;
	}
	public void setComputerorderclassruleclassid(
			Integer computerorderclassruleclassid) {
		this.computerorderclassruleclassid = computerorderclassruleclassid;
	}
	public Date getComputerorderclassruleorderstarttime() {
		return computerorderclassruleorderstarttime;
	}
	public void setComputerorderclassruleorderstarttime(
			Date computerorderclassruleorderstarttime) {
	...
	public Date getComputerorderclassruleorderendtime() {
		return computerorderclassruleorderendtime;
	}
	public void setComputerorderclassruleorderendtime(
			Date computerorderclassruleorderendtime) {
	...
	public Integer getComputerorderclassruleavailableordertime() {
		return computerorderclassruleavailableordertime;
	}
	public void setComputerorderclassruleavailableordertime(
			Integer computerorderclassruleavailableordertime) {
	...
	public Integer getComputerorderclassrulecreateuserid() {
		return computerorderclassrulecreateuserid;
	}
	public void setComputerorderclassrulecreateuserid(
			Integer computerorderclassrulecreateuserid) {
	...
	public Date getComputerorderclassrulecreatetime() {
		return computerorderclassrulecreatetime;
	}
	public void setComputerorderclassrulecreatetime(
			Date computerorderclassrulecreatetime) {
		this.computerorderclassrulecreatetime = computerorderclassrulecreatetime;
	}
	public Integer getComputerorderclassrulestatus() {
		return computerorderclassrulestatus;
	}
