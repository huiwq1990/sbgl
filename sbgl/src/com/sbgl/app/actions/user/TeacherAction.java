...
public class TeacherAction extends ActionSupport implements SessionAware {
	...
	public String alterTeacher() {
		...
		if(returnCode == -1) {
			...
			Usergrouprelation ugr = userGroupRelationService.getRelationByType(teacher.getId(), 6);
			ugr.setGroupId( group.getId() );
	...
	public String deleteTeacher() {
		...
		for (String id : ids) {
			...
			Usergrouprelation temp = userGroupRelationService.getRelationByType(tc.getId(), 6);
