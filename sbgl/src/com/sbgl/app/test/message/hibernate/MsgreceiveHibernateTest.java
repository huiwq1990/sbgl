...
public class MsgreceiveHibernateTest {
	...
	public static void main(String[] args) {
		...
		//查询结果保存到list中
		List<Msgreceive> list = q.list();
		
		//遍历是否存在该id的产品，如果存在则进行输出
		Iterator<Msgreceive> iter = list.iterator();
		while(iter.hasNext()) {		
			Msgreceive obj = iter.next();
