...
public class ComputerconfigHibernateTest {
	...
	public static void main(String[] args) {
		...
		// 使用HQL查询
		String hql = "FROM Computerconfig";
		...
		//查询结果保存到list中
		List<Computerconfig> list = q.list();
		
		//遍历是否存在该id的产品，如果存在则进行输出
		Iterator<Computerconfig> iter = list.iterator();
		while(iter.hasNext()) {		
			Computerconfig obj = iter.next();
