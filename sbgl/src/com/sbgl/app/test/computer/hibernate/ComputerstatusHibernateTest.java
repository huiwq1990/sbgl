...
public class ComputerstatusHibernateTest {
	...
	public static void main(String[] args) {
		...
		// 使用HQL查询
		String hql = "FROM Computerstatus";
		...
		//查询结果保存到list中
		List<Computerstatus> list = q.list();
		
		//遍历是否存在该id的产品，如果存在则进行输出
		Iterator<Computerstatus> iter = list.iterator();
		while(iter.hasNext()) {		
			Computerstatus obj = iter.next();
