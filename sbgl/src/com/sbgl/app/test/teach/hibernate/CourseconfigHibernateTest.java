...
public class CourseconfigHibernateTest {
	...
	public static void main(String[] args) {
		...
		//查询结果保存到list中
		List<Courseconfig> list = q.list();
		
		//遍历是否存在该id的产品，如果存在则进行输出
		Iterator<Courseconfig> iter = list.iterator();
		while(iter.hasNext()) {		
			Courseconfig obj = iter.next();
