...
<!--表单-->             
               <form action="" method="" name="updateComputerorderForm">

		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">id</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computerorder_id" value="${computerorderModel.id}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">number</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computerorder_number" value="${computerorderModel.number}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">userid</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computerorder_userid" value="${computerorderModel.userid}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">createtime</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computerorder_createtime" value="${computerorderModel.createtime}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">status</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computerorder_status" value="${computerorderModel.status}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">starttime</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computerorder_starttime" value="${computerorderModel.starttime}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">endtime</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computerorder_endtime" value="${computerorderModel.endtime}">
                    </div>
                  </div>
			     ...
			     <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-4">
                      ...
                      <button type="submit" onClick = "updateComputerorderAjax()" class="btn btn-primary">保存</button>
                    </div>
                  </div>
<!--表单-->                                  
