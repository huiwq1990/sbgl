	...
	<section id="main-wrap" class="clearfix"><!--main-wrap-->
      ...
      <div id="admin-wrap">
		...
		<div class="form-group">
                    ...
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computerorderdetailid" name="id" placeholder="id">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computerorderid</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computerorderdetailcomputerorderid" name="computerorderid" placeholder="computerorderid">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computerid</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computerorderdetailcomputerid" name="computerid" placeholder="computerid">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computernumber</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computerorderdetailcomputernumber" name="computernumber" placeholder="computernumber">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">createtime</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computerorderdetailcreatetime" name="createtime" placeholder="createtime">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">borrowday</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computerorderdetailborrowday" name="borrowday" placeholder="borrowday">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">borrowperiod</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computerorderdetailborrowperiod" name="borrowperiod" placeholder="borrowperiod">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">status</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computerorderdetailstatus" name="status" placeholder="status">
                    </div>
                  </div>
...
<script src="http://localhost:8080/sbgl/js/bootstrap-hover-dropdown.min.js"></script>
	<script src="http://localhost:8080/sbgl/js/computer/computerorderdetail.js"></script>
  </body>
</html>
