...
<!--表单-->             
               <form action="" method="" name="updateComputerorderdetailForm">

		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">id</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computerorderdetail_id" value="${computerorderdetailModel.id}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computerorderid</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computerorderdetail_computerorderid" value="${computerorderdetailModel.computerorderid}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computerid</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computerorderdetail_computerid" value="${computerorderdetailModel.computerid}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computernumber</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computerorderdetail_computernumber" value="${computerorderdetailModel.computernumber}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">createtime</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computerorderdetail_createtime" value="${computerorderdetailModel.createtime}">
                    </div>
                  </div>
		<div class="form-group">
		...
		<div class="form-group">
			     ...
			     <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-4">
                      ...
                      <button type="submit" onClick = "updateComputerorderdetailAjax()" class="btn btn-primary">保存</button>
                    </div>
                  </div>
<!--表单-->                                  
