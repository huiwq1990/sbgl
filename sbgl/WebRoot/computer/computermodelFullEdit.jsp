	...
	<section id="main-wrap" class="clearfix"><!--main-wrap-->
      ...
      <div id="admin-wrap">
		...
		<div class="form-group">
                    ...
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computermodelid" value="${computermodelFull.computermodelid}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computermodelname</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computermodelname" value="${computermodelFull.computermodelname}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computermodelcomputercategoryid</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computermodelcomputercategoryid" value="${computermodelFull.computermodelcomputercategoryid}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computermodelpicpath</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computermodelpicpath" value="${computermodelFull.computermodelpicpath}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computermodelcreatetime</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computermodelcreatetime" value="${computermodelFull.computermodelcreatetime}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computermodelcreateuserid</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computermodelcreateuserid" value="${computermodelFull.computermodelcreateuserid}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computermodelstatus</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computermodelstatus" value="${computermodelFull.computermodelstatus}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computercategoryid</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computercategoryid" value="${computermodelFull.computercategoryid}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computercategoryparentcomputercategoryid</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computercategoryparentcomputercategoryid" value="${computermodelFull.computercategoryparentcomputercategoryid}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computercategoryname</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computercategoryname" value="${computermodelFull.computercategoryname}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computercategorycreatetime</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computercategorycreatetime" value="${computermodelFull.computercategorycreatetime}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computercategorycreateuserid</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computercategorycreateuserid" value="${computermodelFull.computercategorycreateuserid}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computercategorystatus</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="computercategorystatus" value="${computermodelFull.computercategorystatus}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">loginuserid</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="loginuserid" value="${computermodelFull.loginuserid}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">loginusername</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="loginusername" value="${computermodelFull.loginusername}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">loginusercreatetime</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="loginusercreatetime" value="${computermodelFull.loginusercreatetime}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">loginuserstatus</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="loginuserstatus" value="${computermodelFull.loginuserstatus}">
                    </div>
                  </div>
