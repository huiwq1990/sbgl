...
<!--表单-->             
               <form action="" method="" name="updateComputermodelForm">

		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">id</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computermodel_id" value="${computermodelModel.id}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">name</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computermodel_name" value="${computermodelModel.name}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computercategoryid</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computermodel_computercategoryid" value="${computermodelModel.computercategoryid}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">picpath</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computermodel_picpath" value="${computermodelModel.picpath}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">createtime</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computermodel_createtime" value="${computermodelModel.createtime}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">createuserid</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computermodel_createuserid" value="${computermodelModel.createuserid}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">status</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computermodel_status" value="${computermodelModel.status}">
                    </div>
                  </div>
			     ...
			     <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-4">
                      ...
                      <button type="submit" onClick = "updateComputermodelAjax()" class="btn btn-primary">保存</button>
                    </div>
                  </div>
<!--表单-->                                  
