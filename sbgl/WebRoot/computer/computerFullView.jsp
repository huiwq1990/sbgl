              ...
              <table class="table table-hover">
                ...
                <tbody>					
		          ...
		          <tr>
                    <td><input class="chk" type="checkbox" name="chk-list" value="3"></td>
                    <td>computername</td>
                    <td>${computerFull.computername}</td>                    
                  </tr>               
		          <tr>
                    <td><input class="chk" type="checkbox" name="chk-list" value="3"></td>
                    <td>computercomputercategoryid</td>
                    <td>${computerFull.computercomputercategoryid}</td>                    
                  </tr>               
		          <tr>
                    <td><input class="chk" type="checkbox" name="chk-list" value="3"></td>
		          ...
		          <tr>
                    ...
                    <td>${computerFull.computercategoryid}</td>                    
                  </tr>               
		          <tr>
                    <td><input class="chk" type="checkbox" name="chk-list" value="3"></td>
                    <td>computercategoryname</td>
                    <td>${computerFull.computercategoryname}</td>                    
                  </tr>               
		          <tr>
                    <td><input class="chk" type="checkbox" name="chk-list" value="3"></td>
                    <td>computercategorycreatetime</td>
                    <td>${computerFull.computercategorycreatetime}</td>                    
                  </tr>               
		          <tr>
                    <td><input class="chk" type="checkbox" name="chk-list" value="3"></td>
                    <td>computercategorycreateuserid</td>
                    <td>${computerFull.computercategorycreateuserid}</td>                    
                  </tr>               
		          <tr>
                    <td><input class="chk" type="checkbox" name="chk-list" value="3"></td>
                    <td>computercategorystatus</td>
                    <td>${computerFull.computercategorystatus}</td>                    
                  </tr>               
		          <tr>
                    <td><input class="chk" type="checkbox" name="chk-list" value="3"></td>
                    <td>loginuserid</td>
