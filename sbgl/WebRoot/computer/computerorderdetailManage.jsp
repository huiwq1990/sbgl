              ...
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th class="name">computerorderdetailid</th>
                    <th class="name">computerorderdetailcomputerorderid</th>
				...
				<!--遍历所有属性-->
				<s:iterator id="tempEntityFull" value="computerorderdetailFullList" status="sta">
                  <tr>
                    <td><input class="chk" type="checkbox" name="chk-list" value="3"></td>                   
                                        <td>${ tempEntityFull.computerorderdetailid }</td>
                                        <td>${ tempEntityFull.computerorderdetailcomputerorderid }</td>
