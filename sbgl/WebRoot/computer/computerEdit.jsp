...
<!--表单-->             
               <form action="" method="" name="updateComputerForm">

		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">id</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computer_id" value="${computerModel.id}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">serialnumber</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computer_serialnumber" value="${computerModel.serialnumber}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">name</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computer_name" value="${computerModel.name}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">computercategoryid</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computer_computercategoryid" value="${computerModel.computercategoryid}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">createtime</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computer_createtime" value="${computerModel.createtime}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">createuserid</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computer_createuserid" value="${computerModel.createuserid}">
                    </div>
                  </div>
		<div class="form-group">
                    <label for="inputEquipId" class="col-lg-2 control-label">status</label>
                    <div class="col-lg-4">
                      <input type="text" class="form-control" id="input_computer_status" value="${computerModel.status}">
                    </div>
                  </div>
			     ...
			     <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-4">
                      ...
                      <button type="submit" onClick = "updateComputerAjax()" class="btn btn-primary">保存</button>
                    </div>
                  </div>
<!--表单-->                                  
...
<script src="http://localhost:8080/sbgl/js/computer/computer.js"></script>
</body>
</html>